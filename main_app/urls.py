...
urlpatterns = [
    ...
    path('games/<int:game_id>/update_review/', views.update_review, name='update_review'),
    path('games/<int:game_id>/delete_review/', views.delete_review, name='delete_review'),
